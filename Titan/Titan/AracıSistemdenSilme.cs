...
namespace Titan
{
    public partial class AracıSistemdenSilme : Form
    {
        ...
        public AracıSistemdenSilme()
        {
            InitializeComponent();
        }

        public AracıSistemdenSilme(Form []gelinenTablo)
        {
        ...
        private void AracıSistemdenSilme_Load(object sender, EventArgs e)
        {
        ...
        private void BTEkle_Click(object sender, EventArgs e)
        {
            if (CBArac.SelectedIndex > -1)
            {
                DialogResult result1 = MessageBox.Show("Aracı Sistemden silmek istediğinizden eminmisiniz ?", "Kapatma İşlemi Onayı", MessageBoxButtons.YesNo);
                if (result1.ToString() == "Yes")
                {
                    ...
                    MessageBox.Show("Arac Sistemden silindi ");
                }
                else {
